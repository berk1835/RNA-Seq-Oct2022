...
cat <<\EOF > bwa-rRNA-job-script-BAM.sh
#!/bin/bash
...
################################################################################
#
# Loop to generate commands to convert files to BAM
#
################################################################################

for fname in /lustre/projects/Research_Project-T110796/Project_10762/ages_alignments/fastqs/*_ages_rRNA_alignment.sam.gz
do
